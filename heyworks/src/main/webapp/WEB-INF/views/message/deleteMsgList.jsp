...
<body>
    ...
    <div class="outer">
        ...
        <div class="contents">
            ...
            <!-- 삭제 버튼 -->
            <div class="buttons">
                <button id="goDel" type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">영구삭제</button>
            </div>   
