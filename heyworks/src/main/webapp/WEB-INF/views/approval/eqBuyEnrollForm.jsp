...
<body>
	...
	<div class="outer">
        ...
        <input type="hidden" name="formNo" value="2">
            ...
            <br>
            <button type="button" class="btn btn-sm btn-outline-dark" onclick="removeList();">삭제하기</button>
          ...
          <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div id="confirm-body">
                    ...
                    <!-- 어느라인으로 보낼건지 -->
                    <div id="line">
                        <button type="button" class="btn btn-sm" onclick="list(1);">참조</button>
                        <button type="button" class="btn btn-sm text-danger" onclick="list(2);">*결재1</button>
                    </div>
	...
	<script>
            ...
            function list(num){
                ...
                switch(num){
                    case 1:$("#chamjo").text(nameCheck + " " + jobCheck),$("#refNo").val(noCheck); break;
                    case 2:$("#sign1").text(nameCheck + " " + jobCheck),$("#clist0").val(noCheck); break;
                }
