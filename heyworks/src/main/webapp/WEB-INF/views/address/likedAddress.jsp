...
<body>
	...
	$(document).ready(function(){
			...
			// 이름순
				$("span#nameicon").click(function(){
					...
					location.href = "likeAddress.ad?data="+data+"&sort="+sort;
				});
    ...
    <div class="outer">
		...
		<div id="center" style=" display:inline">
			...
			<!-- 제목영역 -->
			<div id="toparea">
				<span><i class="fas fa-star fa-lg" style=" color: rgb(240, 240, 36);"></i>즐겨찾는 개인주소록</span>
				<span style="font-size: 11px; color: grey;"> in 즐겨찾는 개인주소록 전체 ${listCount}개</span>
			</div>
			<br>
   ...
   <div class="modal fade" id="deleteModal" role="dialog">
	...
	function deleteAddress() {
		...
		function deleteValue() {
			...
			function insertLike(addressNo, aEl) {
